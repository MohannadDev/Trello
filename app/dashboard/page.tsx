...
export default function DashboardPage() {
  ...
  const { isFreeUser } = usePlan(); // Default to blue if color not provided
  ...
  return (
    <>
      <Head>
        <title>Dashboard - Trello Clone</title>
        <meta name="description" content="Manage your projects and tasks with our Trello-inspired dashboard" />
        <meta name="keywords" content="trello, kanban, project management, tasks, boards" />
        <meta property="og:title" content="Dashboard - Trello Clone" />
        <meta property="og:description" content="Manage your projects and tasks with our Trello-inspired dashboard" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Dashboard - Trello Clone" />
        <meta name="twitter:description" content="Manage your projects and tasks with our Trello-inspired dashboard" />
      </Head>
